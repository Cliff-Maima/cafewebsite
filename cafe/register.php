...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM yoooo WHERE email='{$email}'")) > 0) {
        echo "<script>alert('{$email} - email has already taken.');</script>";
    }

    else {
        if ($password === $confirmpassword) {
            $sql = "INSERT INTO yoooo (firstname,lastname,email,phonenumber,county,password) VALUES ('{$firstname}', '{$lastname}', '{$email}', '{$phone}', '{$county}','{$password}')";
            ...
            <div class="col-lg-6">
                <div class="contact-form">
                    <form class="" action="" method="post" autocomplete="off">
                        ...
                        <input type="text" name="firstname" id = "firstname" required value="" placeholder="Enter First Name"> <br>

                        <input type="text" name="lastname" id = "lastname" required value="" placeholder="Enter Last Name"> <br>

                        <input type="email" name="email" id = "email" required value=""  placeholder="Enter email" > <br>

                        <input type="number" name="phone" id = "phonenumber" required value=""  placeholder="Enter Phone number" > <br>
                        <input type="text" name="county" id = "county" required value=""  placeholder="county" > <br>
